...
<ST::NUMBER>PLZ</ST::NUMBER> <ST::TEXT>Ort</ST::TEXT>
}

%%% sender's email
%%% requires fromemail set "true"
\setkomavar{fromemail}{%
<ST::TEXT>EMail</ST::TEXT>
}

%%% sender's name
\setkomavar{fromname}{%
<ST::TEXT>Vorname</ST::TEXT> <ST::TEXT>Nachname</ST::TEXT>
}

%%% sender's phone number
%%% requires fromphone set "true"
\setkomavar{fromphone}{%
<ST::TEXT>Telefonnummer</ST::TEXT>
}
...
\begin{letter}{%
<ST::TEXT>Empfänger_Vorname</ST::TEXT> <ST::TEXT>Empfänger_Nachname</ST::TEXT>\\ 
<ST::TEXT>Empfänger_Anschrift</ST::TEXT>\\ 
<ST::NUMBER>Empfänger_PLZ</ST::NUMBER> <ST::TEXT>Empfänger_Ort</ST::TEXT>
}
