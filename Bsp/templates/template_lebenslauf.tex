...
\begin{cv}{curriculum vit{\ae}}
  ...
  \settowidth{\cvlabelwidth}{\cvlabelfont Staatsbürgerschaft}


  \begin{cvlist}{\de{Titel}\en{Title}~<ST::TEXT>Vorname</ST::TEXT>~<ST::TEXT>Nachname</ST::TEXT>}

  \item [\de{Geboren~am}\en{Date of Birth}] \de{<ST::DATE>Geburtstag</ST::DATE>}\en{Jannuary~1\raisebox{1ex}{st}~19xx}

  \item [\de{Familienstand}\en{Marriage Status}] \de{<ST::TEXT>Familienstand</ST::TEXT>}\en{unmarriedFIXXME}

  \item [\de{Staatsbürgerschaft}\en{Nationality}] \de{<ST::TEXT>Staatsbürgerschaft</ST::TEXT>}\en{AustrianFIXXME}

  \item [\de{Adresse}\en{Address}]
    <ST::TEXT>Anschrift</ST::TEXT>\\
    A-<ST::NUMBER>Postleitzahl_ohne_A-</ST::NUMBER> <ST::TEXT>Wohnort</ST::TEXT>

  \item[\de{Ausbildung}\en{Education}] 

    \begin{itemize}

    \item <ST::NUMBER>Maturajahrgang</ST::NUMBER> \de{Matura}\en{A Levels}
      
    \end{itemize}

  \item [\de{Berufserfahrung}\en{Employment}] \de{<ST::TEXT>Berufserfahrung</ST::TEXT>}\en{FIXXME}

  \item [\de{Führerschein}\en{Driving License}] <ST::TEXT>Führerschein</ST::TEXT>

  \item [\de{Fremdsprachen}\en{Languages}] <ST::TEXT>Fremdsprachen</ST::TEXT>
  ...
  \item[<ST::NUMBER>Monat_Studienbeginn</ST::NUMBER>/<ST::NUMBER>Jahr_Studienbeginn</ST::NUMBER>] \de{Beginn des <ST::TEXT>Studienrichtung</ST::TEXT>-Studiums an der
    <ST::TEXT>Universität</ST::TEXT>}\en{Began study of \href{http://www.telematik.edu}{Telematics} 
                 at \href{http://www.TUGraz.at}{Graz, University of Technology}}
  ...
  \item[<ST::NUMBER>Monat_der_Publikation</ST::NUMBER>/<ST::NUMBER>Jahr_Publikation</ST::NUMBER>] <ST::TEXT>Autoren_der_Publikationen</ST::TEXT>. \emph{Titel.} <ST::TEXT>Name_der_Publikation</ST::TEXT>, <ST::TEXT>Ort_der_Publikation</ST::TEXT>, <ST::TEXT>Land_der_Publikation</ST::TEXT>, <ST::NUMBER>Jahr_Publikation</ST::NUMBER>.
